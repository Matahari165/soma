...
const summary = JSON.parse(await readFile(`${root}/docs/testing/meal-balance-realistic-results/run-summary.json`, "utf8"));
const rawDir = `${root}/docs/testing/meal-balance-realistic-results/raw`;
const raw = new Map();
