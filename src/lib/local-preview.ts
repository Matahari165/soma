...
export const previewScoreHistory = {
  ...
  // Keep the preview dashboard aligned with the effort-v4 scores generated
  // from the four synthetic activity inputs in buildPreviewAnalytics.
  effort: [39, 37, 37, 37, 38, 39, 50],
...
export const previewDashboard: DashboardSnapshot = {
  ...
  scores: [
    ...
    { kind: "effort", score: previewScoreHistory.effort.at(-1) ?? null, status: "steady", label: "Effort", value: "50/100 accomplis", target: "Objectifs quotidiens", delta: "8 900 pas · 33 min en zone", detail: "100 correspond aux quatre objectifs quotidiens atteints.", action: "Interprète ce score avec ton niveau de récupération.", href: "/activity", freshness: { measuredAt: new Date().toISOString(), importedAt: new Date().toISOString(), state: "current", coverage: 1 }, history: previewScoreHistory.effort },
  ],
  summary: "Le sommeil et la récupération sont au-dessus de ta plage récente. Le score d’activité du jour est de 50 sur 100.",
  insights: [
