...
export const previewDashboard: DashboardSnapshot = {
  ...
  scores: [
    ...
    { kind: "effort", score: previewScoreHistory.effort.at(-1) ?? null, status: "steady", label: "Strain", value: "50/100 accomplis", target: "Objectifs quotidiens", delta: "8 900 pas · 33 min en zone", detail: "100 correspond aux quatre objectifs quotidiens atteints.", action: "Interprète ce score avec ton niveau de récupération.", href: "/strain", freshness: { measuredAt: new Date().toISOString(), importedAt: new Date().toISOString(), state: "current", coverage: 1 }, history: previewScoreHistory.effort },
  ],
  summary: "Le sommeil et la récupération sont au-dessus de ta plage récente. Le score Strain du jour est de 50 sur 100.",
  insights: [
