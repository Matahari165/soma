...
export function ObservatoryPageMotion() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        ...
        const animation = entry.target.animate([
          { opacity: .3, transform: "translateY(24px)" },
    ...
    const scan = () => document.querySelectorAll(".health-detail-page > header, .health-detail-page .metric-trend-card, .health-detail-page .health-observatory-panel, .settings-card, .meals-page-score, .meals-page-journal, .meals-page-categories, .meals-page-trends, .meals-page-supplements, .meals-page-recipes").forEach((element) => {
