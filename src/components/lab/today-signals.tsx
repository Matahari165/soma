...
export function PersonalLabMetrics({ data, presentation = "default" }: { data: PersonalLabMetricValues; presentation?: "default" | "worlds" }) {
  ...
  const metrics = [
    ...
    { label: "Strain", keyName: "strain" as const, value: values.effortScore, averageValue: values.averageEffortScore, href: "/strain" },
