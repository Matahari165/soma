...
export function PersonalLabDateStrip({
  ...
  progressByDate,
  onDateChange,
  ariaLabel = "Shared day between meals and journal",
  showDayStatus = true,
}: {
  ...
  return (
    <section className="w-full bg-surface-card/40 personal-lab-day-strip overflow-hidden" data-purpose="timeline-selector" aria-label={ariaLabel}>
