...
type SyncState = { status: SyncStatus; connection?: { lastSyncedAt?: string | null }; jobs?: SyncJob[]; importedRecords?: Record<string, number>; analytics?: { datedRecords: number; metricDays: number; scoreRows: number } };
type Connection = { status: string; scopes?: string[]; last_synced_at?: string | null; metadata?: { consent_complete?: boolean } };
