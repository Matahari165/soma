...
import { AlertCircle, Check, Database, Download, ExternalLink, LoaderCircle, LogOut, RefreshCw, RotateCcw, Save, Shield, Trash2, Unplug } from "lucide-react";
...
export function SettingsConsole({ demoMode }: { demoMode: boolean }) {
  ...
  if (loading) return <div className="workout-loading" role="status"><LoaderCircle className="spin" />Loading settings…</div>;
