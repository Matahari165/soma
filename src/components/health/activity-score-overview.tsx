...
function BreakdownDetail({ breakdown, persistedScore }: { breakdown: ActivityScoreBreakdown | null; persistedScore?: number | null }) {
  ...
  return <>
    ...
    <p className={`${styles.detailFootnote} ${styles.scoreExplanation}`}>Pas, renforcement et minutes en zone : 30 points chacun ; heures actives : 10 points. Au-delà d’un objectif sportif, le dépassement rapporte 60 % des points habituels, jusqu’à 15 points supplémentaires par métrique. Les objectifs peuvent se compenser ; le total est plafonné à 100.</p>
