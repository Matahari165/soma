...
import { RecoveryScoreOverview } from "./recovery-score-overview";
      ...
      <main className={`${styles.content} health-observatory-content`} data-recovery-scroll-reveal-root="true">
        ...
        {latest ? <>
          <section className={`${styles.heroScene} health-observatory-panel`} data-recovery-scroll-reveal="true" aria-labelledby="recovery-score-summary-title">
            <RecoveryScoreOverview dimensions={dimensions} score={score} average={averages.recovery} coverage={coverage} freshnessLabel={freshnessLabel} heroScoreTone={heroScoreTone} scoreAction={recoveryScoreAction} />
          </section>
