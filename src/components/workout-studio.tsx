...
export function WorkoutStudio() {
  ...
  if (loading) return <div className="workout-loading" role="status"><LoaderCircle className="spin" />Loading workout studio…</div>;
  ...
  return <div className="workout-page" id="main-page-content">
    <header className="workout-header"><div><span className="eyebrow">Training studio</span><h1>Workouts</h1><p>Build strength programs, then follow each set with mobile-friendly live controls.</p></div><button className="primary-button" type="button" onClick={() => setBuilderOpen(true)}><Plus size={17} />New program</button></header>
