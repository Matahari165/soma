...
export function WorkoutStudio() {
  ...
  return <div className="workout-page" id="main-page-content">
    <header className="workout-header"><div><h1>Workouts</h1><p>Build a program. Follow every set.</p></div><button className="primary-button" type="button" onClick={() => setBuilderOpen(true)}><Plus size={17} />New program</button></header>
