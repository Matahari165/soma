...
export const healthMetricRegistry: readonly LabMetricDefinition[] = [
  ...
  { id: "sedentary_minutes", label: "Sedentary minutes", unit: "min", field: "sedentary_minutes", defaultRole: "influence", direction: "lower", source: "Google Health" },
  { id: "distance", label: "Distance", unit: "km", field: "distance_km", defaultRole: "disabled", direction: "higher", source: "Google Health" },
  { id: "running_distance", label: "Running distance", unit: "km", field: "running_distance_km", defaultRole: "influence", direction: "higher", source: "Google Health" },
  { id: "running_pace", label: "Running pace", unit: "sec/km", field: "running_pace_seconds_per_km", defaultRole: "both", direction: "lower", source: "Google Health" },
  { id: "running_average_heart_rate", label: "Running average heart rate", unit: "bpm", field: "running_average_heart_rate", defaultRole: "both", direction: "target", source: "Google Health" },
  ...
  { id: "vo2_max", label: "VO₂ max", unit: "ml/kg/min", field: "vo2_max", defaultRole: "result", direction: "higher", source: "Google Health" },
