...
import { previewExercises, previewPrograms } from "@/lib/local-preview";
...
export async function GET() {
  if (isLocalPreviewMode()) return NextResponse.json({ exercises: previewExercises, programs: previewPrograms });
