...
export async function GET() {
  ...
  const [{ data: exercises, error: exerciseError }, { data: programs, error: programError }, goal] = await Promise.all([
  ...
  return NextResponse.json({ exercises: exercises ?? [], programs: programs ?? [], primaryGoal: goal.type, primaryGoalDirection: goal.direction });
}
