...
const userTables = ["profiles", "health_goals", "sleep_preferences", "dashboard_layouts", "nutrition_targets", "sync_jobs", "health_records", "health_record_archives", "daily_health_metrics", "daily_calendar_metrics", "daily_checkins", "journal_variables", "journal_entries", "journal_days", "journal_imports", "lab_narratives", "lab_relation_snapshots", "daily_scores", "insights", "correlation_results", "briefs", "workout_programs", "workout_program_exercises", "workout_sessions", "workout_session_sets", "meals", "meal_photos", "meal_feelings", "meal_analyses", "assistant_conversations", "assistant_messages", "assistant_runs", "assistant_tool_calls", "assistant_memories", "assistant_goal_sets", "assistant_goals", "assistant_plans", "assistant_plan_versions", "assistant_attachments", "assistant_actions", "assistant_action_events", "consent_events", "audit_events"];
