...
export default function PrivacyPage() {
  return (
    <main className="legal-page" id="main-page-content">
      ...
      <article>
        <span className="eyebrow">Privacy · Version 1.0</span>
        <h1>Your health data stays yours.</h1>
        <p>Last updated August 7, 2026.</p>
        <h2>What Soma stores</h2>
        <p>Your Google account identifier, manually entered profile information, authorized Google Health data, derived scores and insights, Coach conversations, and workouts.</p>
