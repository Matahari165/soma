...
| Export | Export d'un **compte de test**, contrôle des tables et des fichiers référencés, sans versionner son contenu | Aperçu synthétique testé localement ; export authentifié de production à faire avec compte de test |
