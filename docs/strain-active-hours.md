...
Le score `effort-v6` combine les pas (10 000), les minutes actives en zone (45) et le renforcement enregistré (10 minutes), à 30 % chacun, et toutes les heures éveillées écoulées actives à 10 %. Jusqu’à l’objectif, la progression est linéaire. Au-delà, le dépassement rapporte 60 % des points habituels, avec un bonus maximal de 50 % du poids (45 points maximum par objectif sportif). Les heures sont plafonnées à 10 points. Les objectifs se compensent ; le total est plafonné à 100 et n’est arrondi à 100 que si la somme atteint réellement 100. Une mesure indisponible rend le score partiel, sans fabriquer un zéro. Les anciennes lignes v5 possédant leurs mesures sont recalculées avec la règle actuelle par le lecteur partagé ; un ancien score sans mesures n’est pas présenté comme le nouveau score.
