...
Cette cartographie part de la version locale d’Activity validée le 24 septembre 2026, branche `codex/strain-annotations-20260924`, commit `644449f`. Elle sert de cible documentaire pour les autres pages ; elle ne signifie pas que celles-ci sont déjà uniformisées ni que cette branche est déjà intégrée à `main`. Les règles de données, sécurité, accessibilité et thème des sections 1 à 18 restent applicables.
